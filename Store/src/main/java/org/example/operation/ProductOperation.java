...
public class ProductOperation {
    ...
    public void byBarCodeProductUpdateOpearion() {
        ...
        switch (category) {
            case 1: {
                productImpl.byBarCodeProduct(barCode, name, count, price, Category.ELECTRONICS);
                break;
            }
            case 2: {
                productImpl.byBarCodeProduct(barCode, name, count, price, Category.CLOTHING);
                break;
            }
            case 3: {
                productImpl.byBarCodeProduct(barCode, name, count, price, Category.FOOD_AND_BEVERAGES);
                break;
            }
            case 4: {
                productImpl.byBarCodeProduct(barCode, name, count, price, Category.BEAUTY_AND_PERSONAL_CARE);
                break;
            }
            case 5: {
                productImpl.byBarCodeProduct(barCode, name, count, price, Category.BOOKS);
                break;
            }
            case 6: {
                productImpl.byBarCodeProduct(barCode, name, count, price, Category.TOYS_AND_GAMES);
                break;
            }
            default:
    ...
    public void ByCategoryOpeartion() {
        ...
        switch (category) {
            case 1: {
                productImpl.byCategoryProduct(Category.ELECTRONICS);
                break;
            }
            case 2: {
                productImpl.byCategoryProduct(Category.CLOTHING);
                break;
            }
            case 3: {
                productImpl.byCategoryProduct(Category.FOOD_AND_BEVERAGES);
                break;
            }
            case 4: {
                productImpl.byCategoryProduct(Category.BEAUTY_AND_PERSONAL_CARE);
                break;
            }
            case 5: {
                productImpl.byCategoryProduct(Category.BOOKS);
                break;
            }
            case 6: {
                productImpl.byCategoryProduct(Category.TOYS_AND_GAMES);
                break;
            }
            default:
    ...
    public void byNameProductOperation() {
        ...
        productImpl.byNameProduct(productName);
    }
